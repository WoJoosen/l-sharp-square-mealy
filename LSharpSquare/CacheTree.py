...
class CacheTree:
    """
    Tree in which all output queries and corresponding outputs/values are stored. Output queries update the tree
    ...
    def in_cache(self, input_seq: tuple):
        """
        Check if the result of the output query for input_seq is cached in the tree. If it is, return the
        corresponding output sequence.

        Args:

            input_seq: corresponds to the output query
...
class CacheDict:
    """
    Dictionary in which all output queries and corresponding outputs/values are stored. Output queries update
